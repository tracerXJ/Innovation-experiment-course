...
#network.vfn_rl(image_placeholder, var_dict, global_feature=global_feature_placeholder,h=h_placeholder, c=c_placeholder)
def vfn_rl(x, variable_dict, global_feature=None, h=None, c=None, embedding_dim=1000):
    ########################## VFN ##################################
    ######################## Layer 1 ################################
    ## conv1  https://blog.csdn.net/flyfish1986/article/details/77508783
    ...
    ## lrn1  局部响应归一化LRN(Local Response Normalization)  https://blog.csdn.net/liuyanlin0102/article/details/80456238
    ...
    action = tf.random.categorical(logits=tf.matmul(h, action1w) + action1b, num_samples=1)
